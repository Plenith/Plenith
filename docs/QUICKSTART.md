...
If something doesn't work as documented, file an issue. The `1031-test`-passing suite + the `validate.sh` probe catch regressions before they ship, but the integration with YOUR specific Splunk/Okta/Slack instance is something only you can validate end-to-end on your side.
